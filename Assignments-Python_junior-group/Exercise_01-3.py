...
x = y = 0
h = l = 50
for i in range(10):  # создаем горизонтальные виджеты
    pygame.draw.rect(screen, (0, 0, 0), (x, y, h, l), 1)
    for ii in range(10):  # создаем вертикальные виджеты
        y += 50
        pygame.draw.rect(screen, (0, 0, 0), (x, y, h, l), 1)
    x += 50  # сместим кординату х для горизонтального ряда
    y = 0  # в новой колонке начнем с координаты y = 0
